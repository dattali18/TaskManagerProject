...
struct AddEditSemesterView: View {
    @Environment(\.presentationMode) var presentationMode
    
    @StateObject var viewModel: AddEditSemesterViewModel

    init(with semester: Semester? = nil) {
        _viewModel = StateObject(wrappedValue: AddEditSemesterViewModel(with: semester))
    }
