...
struct AddEditResourceView: View {
    @Environment(\.presentationMode) var presentationMode
    
    @StateObject var viewModel: AddEditResourceViewModel

    init(resource: Resource? = nil, course: Course? = nil) {
        _viewModel = StateObject(wrappedValue: AddEditResourceViewModel(resource: resource, course: course))
    }
